  ...
  return (
    ...
    >
      ...
      <div className="mb-8 border-b border-cyan-100/15 pb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
         <div className="flex min-w-0 items-center gap-4">
            <img
              ...
              className="h-16 w-16 shrink-0 rounded-2xl object-contain shadow-[0_0_24px_rgba(251,191,36,0.26)] ring-1 ring-amber-100/40"
            />
            <div className="min-w-0">
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-lime-300 leading-none">SpeedMath Coach</p>
              <h2 className="text-2xl sm:text-3xl font-black text-cyan-50 tracking-tight">Performance Analytics</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
         ...
         <div>
            ...
            <div className="space-y-3">
               <div className="flex items-center justify-between px-4 py-3 bg-slate-950/65 rounded-xl border border-cyan-100/15 shadow-[0_8px_22px_rgba(8,47,73,0.22)]">
                  <span className="text-xs font-black text-cyan-50">Under 5s <span className="text-[9px] text-cyan-100/45 ml-1 uppercase">(Fast)</span></span>
                  <span className="font-mono font-black text-base text-emerald-600">{under5}</span>
               </div>
               <div className="flex items-center justify-between px-4 py-3 bg-slate-950/65 rounded-xl border border-cyan-100/15 shadow-[0_8px_22px_rgba(8,47,73,0.22)]">
                  <span className="text-xs font-black text-cyan-50">5s - 10s <span className="text-[9px] text-cyan-100/45 ml-1 uppercase">(Average)</span></span>
                  <span className="font-mono font-black text-base text-amber-500">{between5and10}</span>
               </div>
               <div className="flex items-center justify-between px-4 py-3 bg-slate-950/65 rounded-xl border border-cyan-100/15 shadow-[0_8px_22px_rgba(8,47,73,0.22)]">
                  <span className="text-xs font-black text-cyan-50">Over 10s <span className="text-[9px] text-cyan-100/45 ml-1 uppercase">(Slow)</span></span>
         ...
         <div>
            ...
            <div className="grid grid-cols-2 gap-3 h-[calc(100%-2rem)]">
               <div className="flex flex-col justify-center p-4 bg-emerald-300/10 rounded-2xl border border-emerald-200/35 shadow-[0_8px_22px_rgba(16,185,129,0.12)] text-center">
                  <span className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest mb-2">Fastest Operation</span>
                  <span className="text-xl font-bold text-cyan-50 capitalize tracking-tight">{bestOp.toLowerCase()}</span>
               ...
               <div className="flex flex-col justify-center p-4 bg-rose-300/10 rounded-2xl border border-rose-200/35 shadow-[0_8px_22px_rgba(244,63,94,0.12)] text-center">
                  <span className="text-[10px] font-bold text-rose-600 uppercase tracking-widest mb-2">Needs Practice</span>
                  <span className="text-xl font-bold text-cyan-50 capitalize tracking-tight">{worstOp.toLowerCase()}</span>
      ...
      <div className="mb-8">
         ...
         <div id="recharts_trend_container" className="p-4 bg-slate-950/70 rounded-2xl border border-cyan-100/18 shadow-[0_12px_30px_rgba(8,47,73,0.26)]" >
            {chartData.length === 0 ? (
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {badges.map((badge) => (
               <div 
                 ...
                 className={`flex items-start gap-4 p-4 rounded-[1.5rem] border transition-all duration-200 ${
                   badge.unlocked 
